...
class AsymmetricCroCo3DStereo (CroCoNet):
    ...
    def forward(self, view1, view2):
        ...
        (shape1, shape2), (feat1, feat2), (pos1, pos2) = self._encode_symmetrized(view1, view2) # for view1(336, 512), feat1(1, 672, 1024), pos1(1, 672, 2)

        # combine all ref images into object-centric representation
        dec1, dec2 = self._decoder(feat1, pos1, feat2, pos2) # length 13, shape (1, 672, 1024)
